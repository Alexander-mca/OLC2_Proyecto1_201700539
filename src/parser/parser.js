...
function peg$parse(input, options) {
  ...
  var peg$f6 = function(exp, op, exp1) {

};
  var peg$f7 = function(exp) {

  };
  var peg$f8 = function(exp, op, exp1) {

};
  var peg$f9 = function(op) {
};
  var peg$f10 = function(op) {

};
  var peg$f11 = function(exp) {

};
  var peg$f12 = function(tail) {
  ...
  function peg$parseInstruccion() {
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$parseAsignation();
      if (s0 === peg$FAILED) {
        s0 = peg$parseSentencia_IF();
      }
    }
